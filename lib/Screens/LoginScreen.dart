                        ...
                        child: FlatButton(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 10,),
                              Text("SignIn with Facebook",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: FlatButton(
                          ...
                          child: Ink(
                            ...
                            child: Container(
                              ...
                              child: Text("Skip Login",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                            ),
                          ),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(6),
